...
inline ::PROTOBUF_NAMESPACE_ID::int32 ResultCode::_internal_error() const {
  return error_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ResultCode::error() const {
  // @@protoc_insertion_point(field_get:fixbug.ResultCode.error)
  return _internal_error();
}
inline void ResultCode::_internal_set_error(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  error_ = value;
}
inline void ResultCode::set_error(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_error(value);
  // @@protoc_insertion_point(field_set:fixbug.ResultCode.error)
}
